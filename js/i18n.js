...
(function(){
  ...
  const DICT = {
    id: {
      ...
      'about.timeline_2023':'Mulai coding',
      'about.timeline_2024':'Eksplorasi frontend',
      'about.timeline_now':'Eksplorasi dengan AI',
      'gh.badge_title':'Kontribusi GitHub tahun ini (live)',
      'gh.status':'Status GitHub: online (hijau) / offline (abu)',
    ...
    en: {
      ...
      'about.timeline_2023':'Started coding',
      'about.timeline_2024':'Frontend exploration',
      'about.timeline_now':'Exploring with AI',
      'gh.badge_title': 'GitHub contributions this year (live)',
      'gh.status': 'GitHub status: online (green) / offline (gray)',
      ...
      'projects.year':'Year','projects.role':'Role','projects.stack':'Stack',
      'modal.close':'Close',
    ...
    ja: {
      ...
      'about.timeline_2023':'コーディングを開始',
      'about.timeline_2024':'フロントエンドを探求',
      'about.timeline_now':'AIを使った実験',
      'gh.badge_title': '今年のGitHubコントリビューション（ライブ）',
      'gh.status': 'GitHubステータス：オンライン（緑）/ オフライン（灰）',
      ...
      'projects.year':'年','projects.role':'役割','projects.stack':'技術',
      'modal.close':'閉じる',
    ...
    es: {
      ...
      'about.timeline_2023':'Empecé a programar',
      'about.timeline_2024':'Exploración frontend',
      'about.timeline_now':'Exploración con IA',
      'gh.badge_title': 'Contribuciones de GitHub este año (live)',
      'gh.status': 'Estado de GitHub: en línea (verde) / sin conexión (gris)',
      ...
      'projects.year':'Año','projects.role':'Rol','projects.stack':'Stack',
      'modal.close':'Cerrar',
