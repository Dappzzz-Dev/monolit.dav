...
(function(){
  ...
  const DICT = {
    ...
    en: {
      ...
      'hero.bio':"I build clean, fast websites & web apps — and in my free time, I'm probably tinkering with AI.",
      'hero.cta_projects':'View Projects','hero.cta_contact':'Get in Touch',
      'projects.title':'Projects',
      'projects.lead':'Drag to explore — click an image for project details.',
    ...
    ja: {
      ...
      'hero.role':'フロントエンドデベロッパー — インドネシア・スコハルジョ',
    ...
    es: {
      ...
      'hero.bio':'Hago sitios y apps web limpios y rápidos — y en mi tiempo libre, casi siempre ando trasteando con IA.',
      'hero.cta_projects':'Ver proyectos','hero.cta_contact':'Contáctame',
      'projects.title':'Proyectos',
      'projects.lead':'Arrastra para explorar — haz clic en una imagen para ver los detalles.',
